...
| region            | string | `nil`                 | Region the cluster is running in. For example: `us-east-1`, `eastus`, `us-central1`, etc. For more information, see: 
  - **AWS**: [AWS Global Infrastructure](https://docs.aws.amazon.com/whitepapers/latest/aws-overview/global-infrastructure.html)
  - **GCP**: [GCP Regions and Zones](https://cloud.google.com/compute/docs/regions-zones)
  - **Azure**: [Current Azure Region Names Reference](https://azuretracks.com/2021/04/current-azure-region-names-reference/)
  - **Alibaba**: [Alibaba Cloud Regions and Zones](https://www.alibabacloud.com/help/en/cloud-migration-guide-for-beginners/latest/regions-and-zones)
      |
